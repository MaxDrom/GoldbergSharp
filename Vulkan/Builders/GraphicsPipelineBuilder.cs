...
namespace GoldbergSharp.Vulkan.Builders;
...
public sealed class GraphicsPipelineBuilder
{
    ...
    public class FixedFunctionBuilder(GraphicsPipelineBuilder scope)
    {
        ...
        public FixedFunctionBuilder RasterizationBuilderDepthStencil(
    ...
    public class StageBuilder
    {
        ...
        public StageBuilder TesselationControl(VkShaderInfo tessControl)
        {
            _scope._shaderInfos[
                    ShaderStageFlags.TessellationControlBit] =
                tessControl;
        ...
        public StageBuilder TesselationEvaluation(VkShaderInfo tessEval)
        {
            _scope._shaderInfos[
                    ShaderStageFlags.TessellationEvaluationBit] =
                tessEval;
